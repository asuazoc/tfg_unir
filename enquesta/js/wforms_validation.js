...
// ------------------------------------------------------------------------------------------
   ...
   if(wFORMS) {
		...
		wFORMS.behaviors['validation'] = {
			...
			errMsg_required 	: "Aquest camp &eacute;s obligatori. ",
			errMsg_alpha 		: "No introduïu xifres en els camps de text (a-z). ",
			errMsg_email 		: "L'adre&ccedil;a de correu no &eacute;s v&agrave;lida. ",
			errMsg_integer 	: "Introdu&imiddot;u un nombre enter (p. ex. 3).",
			errMsg_float 		: "Introdu&imiddot;u un nombre decimal (p. ex. 1,9) .",
			errMsg_password 	: "La contrasenya no és segura. Introduïu de quatre a dotze caràcters i combineu-hi majúscules i minúscules. ", // password
			errMsg_alphanum 	: "Introduïu únicament caràcters alfanumèrics (a-z i 0-9). ",
			errMsg_date 		: "La data no és correcta.",
			errMsg_notification : "%% error(s) detectats. El formulari no s'ha pogut enviar. \n Verifiqueu les dades que hi heu introduït. ", // %% errors.
			errMsg_custom		: "Introduïu un valor vàlid.",

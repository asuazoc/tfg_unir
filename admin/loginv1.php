...
if ($_SERVER['REQUEST_METHOD']=="POST"){
	...
	$sql = "SELECT * FROM users WHERE password='".base64_encode($_POST['pass'])."' AND usuari='".$_POST['user']."' ";
...
// en cas contrari inicialitzem la sessió
	...
	$_SESSION['user'] = $row[0]["usuari"];
	$_SESSION['pass'] = $row[0]["password"];
	$_SESSION['name'] = $row[0]["nom"];
   ...
   if(isset($_POST['remember'])){
      setcookie("sistem_cookname", $_SESSION['usuari'], time()+60*60*24*100, "/");
      setcookie("sistem_cookuserid", $_SESSION['ID'], time()+60*60*24*100, "/");
      setcookie("sistem_cookpass", $_SESSION['password'], time()+60*60*24*100, "/");
      setcookie("sistem_cookreal_name", $_SESSION['name'], time()+60*60*24*100, "/");
   }
   header("Location: ".$pag);
}
}
...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
		...
		<div id="login-wrapper" class="png_bg">
			...
			<div id="login-content">
				...
				<div class="notification error png_bg">
					...
					<div>
					Error al iniciar la sessión. Comprueba los valors. </div>
				</div>
					...
					<div class="clear"></div>
					<p>
						<input class="button" value="Iniciar" type="submit">
					</p>
      ...
      <div id="facebox" style="display: none;">       <div class="popup">         <table>           <tbody>             <tr>               <td class="tl"></td><td class="b"></td><td class="tr"></td>             </tr>             <tr>               <td class="b"></td>               <td class="body">                 <div class="content">                 </div>                 <div class="footer">                   <a href="#" class="close">                     <img src="images/closelabel.gif" title="close" class="close_image">                   </a>                 </div>               </td>               <td class="b"></td>             </tr>             <tr>               <td class="bl"></td><td class="b"></td><td class="br"></td>             </tr>           </tbody>         </table>       </div>     </div></body></html>

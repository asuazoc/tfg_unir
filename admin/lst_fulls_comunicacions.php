...
<h2>Comunicacions</h2>
			<p id="page-intro">Resum comunicacions</p>
...
<table id="pagerTable" cellspacing="1" class="tablesorter">
 ...
 <tr>
              ...
              <tbody>
                ...
                <?
$c=0;
$res='select * from comunicacions where removed="N" order by id';
...
?>
                <tr>
                  ...
                  <td><?=$row['titol']?></td>
						<td><a href="comunicacions_show2.php?accio=P&id=<?=$row['id']?>&num=<?=$c;?>" target="_blank">Veure</a></td>
                  <td><a href="comunicacions_privat_show.php?accio=P&id=<?=$row['id']?>&num=<?=$c;?>" target="_blank">Veure</a></td>
                  <!--<td><a href="../upload/<?=$row['resum']?>" target="_blank">Veure</a></td>-->
                  <td><a href="comunicacions_show.php?accio=A&id=<?=$row['id']?>&num=<?=$c;?>" target="_blank">Veure</a></td>
                </tr>
                <?
}
?>

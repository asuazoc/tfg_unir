...
<h2>Comunicacions</h2>
			<p id="page-intro">Diplomes Comunicacions</p>
			...
			<div class="notification information png_bg">
				...
				<div>
<b>Recorda:</b> Pots utilitzar les cap&ccedil;aleres de la taula per ordenar les dades de forma ascendent o descendent.
</div>
			</div>
...
<table id="pagerTable" cellspacing="1" class="tablesorter">
              ...
              <tbody>
                ...
                <?
$c=0;
$aSql='select id,desti,autor,autors,centre,categoria,direccio,poblacio,provincia,cp,tel,fax,email,titol,resum,comunicacio,tema,paraules_clau1,paraules_clau2 from comunicacions where removed="N" order by id';

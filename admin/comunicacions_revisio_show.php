...
if ($_SERVER['REQUEST_METHOD']=='GET'){
	...
	$sql_nota ="select * from comunicacions_nota where id='".$row['id']."' and user='".$user."' and revisio='S'";
	...
	if (mysqli_num_rows($result) > 0) {
	   mysqli_query($con,"UPDATE `comunicacions_nota` SET nota1='$nota1',nota2='$nota2',nota3='$nota3',nota4='$nota4',nota5='$nota5',nota6='$nota6',notatotal='$notatotal',recomanacio='$recomanacio'  WHERE id = '$id' and user='$user' and revisio='S' ");
	} else {
	   mysqli_query($con,"INSERT INTO  `comunicacions_nota` ( `id` ,`user` ,`nota1`,`nota2`,`nota3`,`nota4`,`nota5`,`nota6`,`notatotal`,`recomanacio`,`revisio`) VALUES ('$id','$user','$nota1','$nota2','$nota3','$nota4','$nota5','$nota6','$notatotal','$recomanacio','S')");
	}
...
<table width="75%"  border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
	  ...
	  <tr style="display:none">
		...
		<input type="text" name="notatotal" id="notatotal" maxlength="4" size="4"  onfocus="if(this.value == '0.00') { this.value = ''; }" value="<?=$row_nota['notatotal']?>"  onkeypress='validate(event)'/>
	   </td>
	  </tr>
	<tr>
	    	<td> 

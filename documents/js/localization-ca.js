...
wFORMS.behaviors['validation'].errMsg_required     = "Aquest camp és obligatori. "; // required
wFORMS.behaviors['validation'].errMsg_alpha        = "No introduïu xifres en els camps de text (a-z). "; // no numbers 
wFORMS.behaviors['validation'].errMsg_email        = "L'adreça de correu no és vàlida. "; // validate email 
wFORMS.behaviors['validation'].errMsg_integer      = "Introduïu un nombre enter (p. ex. 3). "; // integer 
...
wFORMS.behaviors['validation'].errMsg_notification = "El formulari no s'ha pogut enviar. Verifiqueu les dades que hi heu introduït. "; // %% errors.

...
// ------------------------------------------------------------------------------------------
   ...
   if(wFORMS) {
		...
		wFORMS.behaviors['validation'] = {
			...
			errMsg_required 	: "This field is mandatory ",
			errMsg_alpha 		: "The text must use alphabetic characters only (a-z, A-Z). Numbers are not allowed.",
			errMsg_email 		: "This does not appear to be a valid email.",
			errMsg_integer 		: "Please enter a number.",
			...
			errMsg_notification : "%% error(s) detected. The form has not been able to send.",  // %% will be replaced by the actual number of errors.
			errMsg_custom		: "Please enter a value.",
